...
#include "pipelines/raster/software_rasterizer_oit/utils/SoftRasterVisibilityUtils.hlsli"
...
float4 ShadeFragment(
    ...
    float3 world_pos;
    {
        ...
        if (use_fallback) {
            ...
            world_pos = ReconstructWorldPos(pixel, frag.depth, width, height, resolve_param.clip2world);
